...
public class PageUtils {
	...
	public static void waitForPageLoad(WebDriver driver, String title){
    	WebDriverWait wait = new WebDriverWait(driver, 100);
    	wait.until(ExpectedConditions.titleIs(title));
    }
	
	public static void waitForNewWindowLoad(final WebDriver driver, final String title) {
	...
	public static boolean isAlertPresent(WebDriver driver){ 
	    try{ 
	        Alert a = new WebDriverWait(driver, 1).until(ExpectedConditions.alertIsPresent());
	        if(null!=a){	            
	            return true;
	        }else{
	            throw new Throwable();
...
//	public static void getScreenShot(WebDriver driver, final String fileLocation, final String project, final String fileName, boolean generateHTML) throws IOException, InterruptedException
//	{
//
//		makeFullScreenshot(driver,fileLocation + project + "-" + fileName + ".png");
//
//		if(generateHTML)
//		{
...
//
//			FileUtils.write(new File(fileLocation + project + "-" + fileName + ".html"), pageSource);	
//		}
//
//		driver.manage().window().fullscreen();
//	}
	
	public static void decorateElementPage(WebDriver driver, WebElement elem)
	{
	...
	public static void getScreenShot(WebDriver driver, final String fileLocation, final String project, final String fileName, boolean generateHTML) throws IOException, InterruptedException
	{
		...
		if(generateHTML)
		{
			...
			pageSource = pageSource.replaceAll("(?s)<script.*?(/>|</script>)", "");
	...
	private static void makeFullScreenshot(WebDriver driver,String strFilename) throws IOException, InterruptedException {
